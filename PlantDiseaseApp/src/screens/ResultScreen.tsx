                ...
                <body>
                    <div class="page">
                        ...
                        <div class="header">
                            ...
                            <div class="header-subtitle">AI-Powered Plant Health Analysis</div>
                        ...
                        <div class="content">
                            ...
                            <div class="section">
                                ...
                                ${qualityIssues.map((issue: string) => `
                                    <div class="quality-issue">⚠️ ${issue}</div>
                                `).join('')}
                            </div>
                            ` : ''}
                            ...
                            <div class="section">
                                <div class="section-title">⚠️ Symptoms</div>
                            ...
                            <div class="section">
                                <div class="section-title">🛡️ Prevention & Treatment</div>
                        ...
                        <!-- Footer -->
                        <div class="footer">
                            <div class="footer-brand">🌿 PlantDiseaseApp AI</div>
                            <div class="footer-text">🌱 Protect Your Plants, Protect Our Future 🌱</div>
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.resultContainer}>
                        ...
                        {qualityIssues.length > 0 && (
                            <View style={styles.qualityIssuesContainer}>
                                {qualityIssues.map((issue: string, i: number) => (
                                    <Text key={i} style={styles.qualityIssueText}>⚠️ {issue}</Text>
                                ))}
                            </View>
                        )}
                ...
                {prediction.symptoms && prediction.symptoms.length > 0 && (
                    <View style={styles.section}>
                        <Text style={styles.sectionTitle}>⚠️ Key Symptoms</Text>
                ...
                {prediction.prevention && prediction.prevention.length > 0 && (
                    <View style={styles.section}>
                        <Text style={styles.sectionTitle}>🛡️ Prevention & Treatment</Text>
                        {prediction.prevention.map((p: string, i: number) => (
